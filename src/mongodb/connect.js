...
var dbConnection = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, mongoose_1["default"].connect("mongodb+srv://admin:admin@cluster0.q8ln9bh.mongodb.net/?retryWrites=true&w=majority")];
            case 1:
                _a.sent();
...
var Usr = mongoose_1["default"].model('usuario', userSchema);
var usr = new Usr({
    Nombres: 'felipe',
    Apellidos: 'felipe',
